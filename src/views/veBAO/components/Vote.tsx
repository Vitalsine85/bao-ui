						...
						<Tab.Pane eventKey='new-proposal'>
							<Form>
								<Form.Group className='mb-3' controlId='proposalTitle'>
									...
									<Form.Control type='text' placeholder='vitalsine.eth' disabled readOnly />
								</Form.Group>
								<Form.Group className='mb-3' controlId='proposalTitle'>
								...
								<Form.Group className='mb-3' controlId='votingPeriod'>
									...
									<InputGroup className='mb-3'>
										<Form.Control type='voting-period' placeholder='3' required />
								...
								<Row>
									<Form.Group as={Col} className='mb-3' controlId='proposalTitle'>
										<Form.Label>Proposal Discussion</Form.Label>
										<Form.Control type='title' placeholder='Enter link to discussion' required />
									</Form.Group>
									<Form.Group as={Col} className='mb-3' controlId='proposalTitle'>
										<Form.Label>Additional Documentation</Form.Label>
										<Form.Control type='title' placeholder='Enter link to documentation' required />
									</Form.Group>
								</Row>
