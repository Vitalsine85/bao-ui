...
const MigrationButton: React.FC<MigrationButtonProps> = ({ inputVal, maxValue }: MigrationButtonProps) => {
	...
	const inputApproval = useAllowancev2(Config.addressMap.BAO, Config.contracts.stabilizer[Config.networkId].address)
	...
	const handleClick = async () => {
		...
		if (!inputApproval.gt(0)) {
			...
			return handleTx(approvev2(tokenContract, SwapperContract, account), 'Migration: Approve BAOv1')
		}
